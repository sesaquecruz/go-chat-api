...
func NewRoomRepository(db *sql.DB) *RoomRepository {
	return &RoomRepository{
		db:     db,
		logger: log.NewLogger("RoomRepository"),
	}
}
...
func (r *RoomRepository) FindById(ctx context.Context, id *valueobject.Id) (*entity.Room, error) {
	stmt, err := r.db.PrepareContext(ctx, `
...
func (r *RoomRepository) Search(ctx context.Context, query *pagination.Query) (*pagination.Page[*entity.Room], error) {
...
func (r *RoomRepository) Delete(ctx context.Context, id *valueobject.Id) error {
	stmt, err := r.db.PrepareContext(ctx, `
		DELETE FROM rooms 
		WHERE id = $1
	`)
